    ...
    return (
        <div className='container'>
            <div className="section-top-container for-employees-card">
                <img className='section-top-background img-fluid' src={top_section}></img>
                ...
                <div className="section-top-content">
                    ...
                    <div className="section-top-content-points-container">
                        <div className="section-top-content-point">
                            <img width="16px" height="16px" src={check} />
                    ...
                    <div className='container-box'>                            
                            ...
                            <p style={{ color: "#EFE5FF", fontWeight: "lighter", fontSize: "12px"}}><span style={{ fontWeight: "bold", fontSize: "24px" }}>+360 </span><br />Happy Companies</p>
                        </div>
                    </div>
    ...
    return (
        <div className='container'>
            ...
            <div className='section-container grey-back'>
                ...
                <div className='faq-section-details'>We have Compiled the most commonly asked question about our Platform for your information and<br /> to enhance your overall experience.</div>
